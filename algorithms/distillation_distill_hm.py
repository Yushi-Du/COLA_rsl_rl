...
# rsl-rl
from rsl_rl.modules import StudentTeacherDistill, StudentTeacherRecurrent, StudentTeacherDistill_HM
from rsl_rl.storage import RolloutStorage


class DistillationDistill_HM:
    """Distillation algorithm for training a student model to mimic a teacher model."""

    policy: StudentTeacherDistill | StudentTeacherRecurrent | StudentTeacherDistill_HM
