...
from rsl_rl.modules import ActorCriticWbcEnd2endFollowingOnlyCnn
...
class PPO_WbcEnd2endOnlyCnn:
    """Proximal Policy Optimization algorithm (https://arxiv.org/abs/1707.06347)."""

    policy: ActorCriticWbcEnd2endFollowingOnlyCnn
    ...
    def __init__(
        ...
        # Create optimizer
        self.optimizer = optim.Adam(list(self.policy.actor_cnn.parameters()) + list(self.policy.critic_cnn.parameters()), lr=learning_rate)
