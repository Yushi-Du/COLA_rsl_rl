...
from rsl_rl.modules import ActorCriticWbcEnd2endQuat, ActorCriticWbcEnd2endQuatTransformer
...
class PPO_WbcEnd2endQuat:
    ...
    policy: ActorCriticWbcEnd2endQuat | ActorCriticWbcEnd2endQuatTransformer
