...
class ActorCriticWbcEnd2endFollowingWholePipeQuatResiVelHM29(nn.Module):
    is_recurrent = False
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.actor_obs_dim = num_actor_obs - self.history_length * (13) - 187
        self.critic_obs_dim = num_critic_obs - self.history_length * (13) - 187
    ...
    def actor_forward(self, observations, inference=False):
        ...
        observations_without_hm = observations[:, 0:-187]
        flattened_obs = observations_without_hm.reshape(observations_without_hm.shape[0], self.history_length, -1)
    ...
    def load_state_dict(self, state_dict, strict=True):
        ...
        # (DDP broadcast_parameters re-enters this with rank-0 tensors on cuda:0).
