...
class ActorCriticWbcEnd2endFollowingWholePipeQuatResiVel29Mass(nn.Module):
    is_recurrent = False
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.actor_obs_dim = num_actor_obs - self.history_length * (14)
        self.critic_obs_dim = num_critic_obs - self.history_length * (14)
    ...
    def actor_forward(self, observations, inference=False):
        ...
        other_features = flattened_obs[:, :, 18+29+29:-14]  # (-1, history_length, other_features_dim)
        previliged_features = flattened_obs[:, :, -14:]  # (-1, history_length, 13)
    ...
    def critic_forward(self, observations, inference=False):
        ...
        joint_pos = flattened_obs[:, :, 18:18+29]  # (-1, history_length, 29)
        joint_vel = flattened_obs[:, :, 18+29:18+29+29]  # (-1, history_length, 29)
        other_features = flattened_obs[:, :, 18+29+29:-(14+5)]  # (-1, history_length, other_features_dim)
        previliged_features = flattened_obs[:, :, -(14+5):-5]  # (-1, history_length, 13)
