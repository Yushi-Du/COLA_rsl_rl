...
class ActorCriticWbcEnd2endQuatTransformer(nn.Module):
    is_recurrent = False
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Policy
        self.actor = TransformerResidualNetwork(
            input_dim=int(self.mono_actor_obs_dim / self.history_length),
    ...
    def process_observations(self, observations, inference=False):
        ...
        return self.actor(flattened_obs)
