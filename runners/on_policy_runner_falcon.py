...
class OnPolicyRunnerFalcon:
    ...
    def load(self, path: str, load_optimizer: bool = True):
        ...
        # -- Load model
        resumed_training = self.alg.policy.load_state_dict(loaded_dict)
        ...
        if load_optimizer and resumed_training and "optimizer_state_dict" in loaded_dict.keys():
            # -- algorithm optimizer
