...
import rsl_rl
from rsl_rl.algorithms import PPO, PPO_End2end, PPO_WbcEnd2end, PPO_WbcEnd2endOnlyCnn, PPO_WbcEnd2endWholePipe, PPO_WbcEnd2endOnlyHead, PPO_FalconWbcEnd2endFollowing, PPO_End2endGtCommand, Distillation
...
class OnPolicyRunnerOnlyHead:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        elif self.alg_cfg["class_name"] == "PPO_End2end" or self.alg_cfg["class_name"] == "PPO_End2endGtCommand" or self.alg_cfg["class_name"] == "PPO_WbcEnd2end" or self.alg_cfg["class_name"] == "PPO_WbcEnd2endOnlyCnn" or self.alg_cfg["class_name"] == "PPO_WbcEnd2endWholePipe" or self.alg_cfg["class_name"] == "PPO_WbcEnd2endOnlyHead" or self.alg_cfg["class_name"] == "PPO_FalconWbcEnd2endFollowing":
            self.training_type = "rl"  # 6_3: 是rl
        ...
        policy: ActorCritic | ActorCriticEnd2end | ActorCriticEnd2endFollowing | ActorCriticWbcEnd2endFollowing | ActorCriticWbcEnd2endFollowingOnlyCnn | ActorCriticWbcEnd2endFollowingWholePipe | ActorCriticWbcEnd2endFollowingOnlyHeadQuat | ActorCriticWbcEnd2endFollowingWholePipeQuat | ActorCriticEnd2endFollowingGtCommand | ActorCriticFalconWbcEnd2endFollowing | ActorCriticTransformer | ActorCriticRecurrent | StudentTeacher | StudentTeacherRecurrent = policy_class(
